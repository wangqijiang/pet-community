{
  ...
  "version": "0.0.1",
  "scripts": {
    "h5:dev": "npm-run-all --parallel mock h5:serve",
    "h5:serve": "uni --mode development",
    "h5:deploy": "uni build --mode deployment",
    "h5:build": "uni build --mode production",
    "wx:dev": "npm-run-all --parallel mock wx:serve",
    "wx:serve": "uni -p mp-weixin --mode development",
    "wx:deploy": "uni build -p mp-weixin --mode deployment",
    "wx:build": "uni build -p mp-weixin --mode production",
    "app:dev": "npm-run-all --parallel mock app:serve",
    "app:serve": "uni -p app --mode development",
    "app:build": "uni build -p app --mode production",
    "lint": "eslint --ext .js,.jsx,.vue,.ts,.tsx src --fix",
    "mock": "cd mock && ts-node-dev mock.ts",
    "publish": "node ./bin/publish.js",
    "sftp": "node ./bin/sftp.js"
  },
  "dependencies": {
